...
Cart.prototype.saveToLocalStorage = function() {
  ...
  let stringifiedCart = JSON.stringify(state);
  console.log(stringifiedCart);
  localStorage.setItem('contents',stringifiedCart);
};

Cart.prototype.removeItem = function(item) {
  //! Maybe: Fill in this instance method to remove one item from the cart.
